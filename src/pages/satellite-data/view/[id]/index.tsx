...
import { getSatelliteDataById } from 'apiSdk/satellite-data';
...
function SatelliteDataViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Satellite Data Detail View
          </Text>
          {hasAccess('satellite_data', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/satellite-data/edit/${data?.id}`} passHref legacyBehavior>
              <Button
